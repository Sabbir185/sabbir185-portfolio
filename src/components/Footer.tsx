      ...
      <div className="container">
        <div className="footer-top">
          ...
          <div className="footer-brand">
            ...
            <p>
              Software Engineer crafting scalable web applications with modern technologies.
          ...
          <div className="footer-column">
            <h4>Technologies</h4>
            <a href="#about">React & Next.js</a>
            <a href="#about">Node.js & Go</a>
            <a href="#about">Cloud & DevOps</a>
            <a href="#about">Databases</a>
          </div>
          ...
          <div className="footer-column">
            ...
            <Link href="/blogs">Blog Archive</Link>
            <Link href="/projects">All Projects</Link>
            <a href="https://github.com/sabbir185" target="_blank" rel="noopener noreferrer">GitHub</a>
          </div>
        </div>

        <div className="footer-bottom">
          <p>
            © {currentYear} <a href="/">Sabbir Ahmmed</a>. Crafted with ❤️ and Next.js. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
